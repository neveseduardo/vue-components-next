...
// Color variants
const colorVariants = reactive({
	defaultNormal: '',
	defaultInvalid: 'Invalid value',
	neutralNormal: '',
	neutralInvalid: 'Invalid value',
});
